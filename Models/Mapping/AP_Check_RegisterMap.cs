...
{
    public class AP_Check_RegisterMap : EntityTypeConfiguration<AP_Check_Register>
    {
        public AP_Check_RegisterMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Ven_num, t.Ven_nam, t.gl_cmp_key, t.gl_paycd_key });
            ...
            this.ToTable("AP_Check_Register");
