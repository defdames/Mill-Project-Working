...
{
    public class CHINESE_inventory_by_lot2Map : EntityTypeConfiguration<CHINESE_inventory_by_lot2>
    {
        public CHINESE_inventory_by_lot2Map()
        {
            // Primary Key
            ...
            this.ToTable("CHINESE_inventory_by_lot2");
