...
{
    public class CHINA_COA_Test_InstructionsMap : EntityTypeConfiguration<CHINA_COA_Test_Instructions>
    {
        public CHINA_COA_Test_InstructionsMap()
        {
            // Primary Key
            ...
            this.ToTable("CHINA_COA_Test_Instructions");
