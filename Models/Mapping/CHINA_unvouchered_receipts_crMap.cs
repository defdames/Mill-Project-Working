...
{
    public class CHINA_unvouchered_receipts_crMap : EntityTypeConfiguration<CHINA_unvouchered_receipts_cr>
    {
        public CHINA_unvouchered_receipts_crMap()
        {
            // Primary Key
            ...
            this.ToTable("CHINA_unvouchered_receipts_cr");
