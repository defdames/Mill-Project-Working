...
{
    public class CHINA_proforma_invoice_lotdetailMap : EntityTypeConfiguration<CHINA_proforma_invoice_lotdetail>
    {
        public CHINA_proforma_invoice_lotdetailMap()
        {
            // Primary Key
            ...
            this.ToTable("CHINA_proforma_invoice_lotdetail");
