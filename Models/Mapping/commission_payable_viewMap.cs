...
{
    public class commission_payable_viewMap : EntityTypeConfiguration<commission_payable_view>
    {
        public commission_payable_viewMap()
        {
            // Primary Key
            this.HasKey(t => new { t.gl_cmp_key, t.so_salsm_key, t.so_hdr_key, t.so_dtl_key, t.so_comtr_soamt, t.so_comtr_cmval, t.so_comtr_booked, t.so_comtr_trndt, t.in_prod_key, t.in_prod_desc, t.so_shpqt_qty, t.ar_bill_name, t.so_salsm_name, t.ar_terms_desc });
            ...
            this.ToTable("commission_payable_view");
