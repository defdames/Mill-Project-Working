...
{
    public class CHINA_order_acknowlegementMap : EntityTypeConfiguration<CHINA_order_acknowlegement>
    {
        public CHINA_order_acknowlegementMap()
        {
            // Primary Key
            ...
            this.ToTable("CHINA_order_acknowlegement");
