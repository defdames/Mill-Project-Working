...
{
    public class agent_sample_scheduledMap : EntityTypeConfiguration<agent_sample_scheduled>
    {
        public agent_sample_scheduledMap()
        {
            // Primary Key
            ...
            this.ToTable("agent_sample_scheduled");
