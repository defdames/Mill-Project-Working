...
{
    public class mis_cube_sales_sj_costs_ssMap : EntityTypeConfiguration<mis_cube_sales_sj_costs_ss>
    {
        public mis_cube_sales_sj_costs_ssMap()
        {
            // Primary Key
            ...
            this.ToTable("mis_cube_sales_sj_costs_ss");
