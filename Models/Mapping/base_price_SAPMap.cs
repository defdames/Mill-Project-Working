...
{
    public class base_price_SAPMap : EntityTypeConfiguration<base_price_SAP>
    {
        public base_price_SAPMap()
        {
            // Primary Key
            this.HasKey(t => new { t.gl_cmp_key, t.pc_bsprhd_key, t.pc_bsprdt_ppcind, t.pc_bsprdt_prod, t.im_pack_key, t.pc_bsprdt_price, t.pc_bsprdt_uom });
