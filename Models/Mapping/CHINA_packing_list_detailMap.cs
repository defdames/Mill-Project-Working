...
namespace Mill_Project.Models.Mapping
{
    public class CHINA_packing_list_detailMap : EntityTypeConfiguration<CHINA_packing_list_detail>
    {
        public CHINA_packing_list_detailMap()
        {
            ...
            this.ToTable("CHINA_packing_list_detail");
