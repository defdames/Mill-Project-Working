...
{
    public class tmp_crm_integration_viewMap : EntityTypeConfiguration<tmp_crm_integration_view>
    {
        public tmp_crm_integration_viewMap()
        {
            // Primary Key
            ...
            this.ToTable("tmp_crm_integration_view");
