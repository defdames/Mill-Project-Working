...
{
    public class MIS_Cube_Sales_Consolidated_NewSegment_outperform_daily_pictureMap : EntityTypeConfiguration<MIS_Cube_Sales_Consolidated_NewSegment_outperform_daily_picture>
    {
        public MIS_Cube_Sales_Consolidated_NewSegment_outperform_daily_pictureMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Company, t.Ship_Whse, t.Act_Fcst, t.Region, t.SALESMGR });
            ...
            this.ToTable("MIS_Cube_Sales_Consolidated_NewSegment_outperform_daily_picture");
