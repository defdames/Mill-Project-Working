...
{
    public class CHINA_Gl_Balsheet_LiabMap : EntityTypeConfiguration<CHINA_Gl_Balsheet_Liab>
    {
        public CHINA_Gl_Balsheet_LiabMap()
        {
            // Primary Key
            ...
            this.ToTable("CHINA_Gl_Balsheet_Liab");
