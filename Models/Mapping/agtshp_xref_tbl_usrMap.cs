...
{
    public class agtshp_xref_tbl_usrMap : EntityTypeConfiguration<agtshp_xref_tbl_usr>
    {
        public agtshp_xref_tbl_usrMap()
        {
            // Primary Key
            this.HasKey(t => t.agent_ship_id);
            ...
            this.ToTable("agtshp_xref_tbl_usr");
