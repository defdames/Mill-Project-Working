...
{
    public class ACC_INVCOMM_REPORT_SPLIT_MISC2Map : EntityTypeConfiguration<ACC_INVCOMM_REPORT_SPLIT_MISC2>
    {
        public ACC_INVCOMM_REPORT_SPLIT_MISC2Map()
        {
            // Primary Key
            ...
            this.ToTable("ACC_INVCOMM_REPORT_SPLIT_MISC2");
            ...
            this.Property(t => t.inen).HasColumnName("inen");
        }
    }
}
