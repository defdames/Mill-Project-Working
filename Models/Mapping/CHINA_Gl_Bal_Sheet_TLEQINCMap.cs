...
{
    public class CHINA_Gl_Bal_Sheet_TLEQINCMap : EntityTypeConfiguration<CHINA_Gl_Bal_Sheet_TLEQINC>
    {
        public CHINA_Gl_Bal_Sheet_TLEQINCMap()
        {
            // Primary Key
            ...
            this.ToTable("CHINA_Gl_Bal_Sheet_TLEQINC");
            ...
            this.Property(t => t.PeriorYR).HasColumnName("PeriorYR");
