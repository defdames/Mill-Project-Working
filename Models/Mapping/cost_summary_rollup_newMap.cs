...
{
    public class cost_summary_rollup_newMap : EntityTypeConfiguration<cost_summary_rollup_new>
    {
        public cost_summary_rollup_newMap()
        {
            // Primary Key
            this.HasKey(t => new { t.in_item_key, t.pack, t.sf_plant_key, t.sf_prcss_ver, t.ca_cstyp_id, t.basecost_perunit, t.bulkcost_perunit, t.matlcost_perunit, t.rsrcecost_perunit, t.standard_cost, t.gl_cmp_key });
            ...
            this.ToTable("cost_summary_rollup_new");
