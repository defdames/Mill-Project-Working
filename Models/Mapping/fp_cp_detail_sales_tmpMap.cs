...
{
    public class fp_cp_detail_sales_tmpMap : EntityTypeConfiguration<fp_cp_detail_sales_tmp>
    {
        public fp_cp_detail_sales_tmpMap()
        {
            // Primary Key
            ...
            this.ToTable("fp_cp_detail_sales_tmp");
