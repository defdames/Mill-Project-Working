...
{
    public class copy_mis_cube_distdb_daily_pictureMap : EntityTypeConfiguration<copy_mis_cube_distdb_daily_picture>
    {
        public copy_mis_cube_distdb_daily_pictureMap()
        {
            // Primary Key
            ...
            this.ToTable("copy_mis_cube_distdb_daily_picture");
