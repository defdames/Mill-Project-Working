...
{
    public class in_srl_tbl_historyMap : EntityTypeConfiguration<in_srl_tbl_history>
    {
        public in_srl_tbl_historyMap()
        {
            // Primary Key
            this.HasKey(t => new { t.gl_cmp_key, t.gl_perod_id, t.gl_perod_year, t.in_whs_key, t.in_locn_key, t.in_item_key, t.in_lot_key });
            ...
            this.ToTable("in_srl_tbl_history");
