...
{
    public class channelpartner_detail_sales_dempseybadMap : EntityTypeConfiguration<channelpartner_detail_sales_dempseybad>
    {
        public channelpartner_detail_sales_dempseybadMap()
        {
            // Primary Key
            ...
            this.ToTable("channelpartner_detail_sales_dempseybad");
