...
{
    public class List_of_Powders_AR_tblMap : EntityTypeConfiguration<List_of_Powders_AR_tbl>
    {
        public List_of_Powders_AR_tblMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("List_of_Powders_AR_tbl");
