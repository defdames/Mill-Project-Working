...
{
    public class InkMap : EntityTypeConfiguration<Ink>
    {
        public InkMap()
        {
            // Primary Key
            ...
            this.Property(t => t.Type_Leafing_NonLeafing)
                .HasMaxLength(50);
            ...
            this.Property(t => t.Type_Leafing_NonLeafing).HasColumnName("Type Leafing/NonLeafing");
            ...
            this.Property(t => t.Ink_Vehicle).HasColumnName("Ink Vehicle");
            this.Property(t => t.Drawdown_RK_Prints_description).HasColumnName("Drawdown/RK Prints description");
