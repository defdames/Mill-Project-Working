...
namespace Mill_Project.Models.Mapping
{
    public class CHINESE_bill_invoiceMap : EntityTypeConfiguration<CHINESE_bill_invoice>
    {
        public CHINESE_bill_invoiceMap()
        {
            ...
            this.ToTable("CHINESE_bill_invoice");
