...
{
    public class aged_materialMap : EntityTypeConfiguration<aged_material>
    {
        public aged_materialMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ItemKey, t.LotKey, t.Whse, t.Loc, t.QoH, t.gl_cmp_key });
