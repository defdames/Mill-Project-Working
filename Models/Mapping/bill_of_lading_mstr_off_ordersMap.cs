...
{
    public class bill_of_lading_mstr_off_ordersMap : EntityTypeConfiguration<bill_of_lading_mstr_off_orders>
    {
        public bill_of_lading_mstr_off_ordersMap()
        {
            // Primary Key
            this.HasKey(t => new { t.so_hdr_key, t.so_dtl_key, t.so_ship_date, t.ar_ship_key, t.so_hdr_cpono, t.ar_bill_key, t.FrgtKey, t.WhsName, t.WhsLine1, t.ShipWt, t.NoPkg, t.HM, t.in_whs_key });
            ...
            this.ToTable("bill_of_lading_mstr_off_orders");
