...
{
    public class advpl_export_view_published_allmonthsMap : EntityTypeConfiguration<advpl_export_view_published_allmonths>
    {
        public advpl_export_view_published_allmonthsMap()
        {
            // Primary Key
            this.HasKey(t => t.Products_At_Warehouses_Planning_Family);
            ...
            this.ToTable("advpl_export_view_published_allmonths");
