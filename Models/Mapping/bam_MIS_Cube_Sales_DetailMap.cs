...
{
    public class bam_MIS_Cube_Sales_DetailMap : EntityTypeConfiguration<bam_MIS_Cube_Sales_Detail>
    {
        public bam_MIS_Cube_Sales_DetailMap()
        {
            // Primary Key
            this.HasKey(t => new { t.product, t.en_item_key, t.en_ship_name, t.hdrkey, t.dtlkey, t.soldto, t.gl_cmp_key, t.ar_bill_key, t.ManufacturingLoc, t.CD, t.Invoice_Num, t.SO_Num, t.Ship_Whse });
            ...
            this.ToTable("bam_MIS_Cube_Sales_Detail");
