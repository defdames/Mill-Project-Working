...
{
    public class BGL_DepartmentMap : EntityTypeConfiguration<BGL_Department>
    {
        public BGL_DepartmentMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Type, t.Class, t.Acct, t.AcctDesc, t.Deb_Cred, t.PeriodID, t.RTYPE, t.gl_class_key2, t.hdept, t.gl_class_key5 });
