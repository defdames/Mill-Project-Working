...
{
    public class CHINA_GL_Inc_NewOtherincMap : EntityTypeConfiguration<CHINA_GL_Inc_NewOtherinc>
    {
        public CHINA_GL_Inc_NewOtherincMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Type, t.Class, t.AcctDesc, t.Deb_Cred, t.gl_cmp_key });
            ...
            this.ToTable("CHINA_GL_Inc_NewOtherinc");
