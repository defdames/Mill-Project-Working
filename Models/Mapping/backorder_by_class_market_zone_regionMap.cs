...
{
    public class backorder_by_class_market_zone_regionMap : EntityTypeConfiguration<backorder_by_class_market_zone_region>
    {
        public backorder_by_class_market_zone_regionMap()
        {
            // Primary Key
            this.HasKey(t => new { t.so_hdr_typec, t.Order_No_, t.ar_ship_key, t.im_adres_cntry, t.Product, t.so_dtl_stats, t.so_dtl_shsdt, t.so_prod_shipf, t.so_dtl_key, t.EN_PROD_DESC, t.so_dtl_prmdt, t.so_dtl_reqdt, t.ITEMSTATUS, t.LineStatus, t.OrderDate, t.gl_cmp_key });
            ...
            this.ToTable("backorder_by_class_market_zone_region");
