...
{
    public class days_supply_raw_daily_pictureMap : EntityTypeConfiguration<days_supply_raw_daily_picture>
    {
        public days_supply_raw_daily_pictureMap()
        {
            // Primary Key
            ...
            this.ToTable("days_supply_raw_daily_picture");
