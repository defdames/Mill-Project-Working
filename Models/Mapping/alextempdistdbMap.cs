...
{
    public class alextempdistdbMap : EntityTypeConfiguration<alextempdistdb>
    {
        public alextempdistdbMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Company, t.ShiptoName, t.SalesType, t.CustomerWhse });
