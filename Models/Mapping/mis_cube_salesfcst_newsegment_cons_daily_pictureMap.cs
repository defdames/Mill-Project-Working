...
{
    public class mis_cube_salesfcst_newsegment_cons_daily_pictureMap : EntityTypeConfiguration<mis_cube_salesfcst_newsegment_cons_daily_picture>
    {
        public mis_cube_salesfcst_newsegment_cons_daily_pictureMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Act_Fcst, t.InterCoRegion, t.market, t.salesmgr });
            ...
            this.ToTable("mis_cube_salesfcst_newsegment_cons_daily_picture");
