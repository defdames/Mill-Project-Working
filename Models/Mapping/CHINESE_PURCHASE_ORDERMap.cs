...
{
    public class CHINESE_PURCHASE_ORDERMap : EntityTypeConfiguration<CHINESE_PURCHASE_ORDER>
    {
        public CHINESE_PURCHASE_ORDERMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Ven_key, t.Po_num, t.im_pack_key, t.Remarks, t.ConfVia, t.ConfWith, t.vend_nm, t.Date_ordrd, t.Date_reqrd, t.DtlType, t.Detlkey, t.comm_Req, t.UOM, t.Carrier, t.Qty_ordrd, t.Price_Qty, t.Price_Uom, t.Descr, t.Dtlcomments, t.Byr_Cde, t.Stats_Code, t.Whname, t.Wh_Addr1, t.Wh_Key, t.Wh_addr2, t.Wh_Postc, t.Wh_City, t.Wh_st, t.Wh_cntry, t.Frt_Terms, t.po_hdr_orddt, t.po_hdr_reqdt, t.gl_cmp_key, t.po_hdr_revno, t.unit_price_foreign, t.EN_SERVICE_KEY, t.po_dtl_stats, t.GL_VATRATE_PCT, t.PO_DTL_CMMTS, t.ap_remt_key, t.po_dtl_vatcf, t.LineOrder });
            ...
            this.ToTable("CHINESE_PURCHASE_ORDER");
