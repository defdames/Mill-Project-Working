...
{
    public class agent_sample_scheduled_vwMap : EntityTypeConfiguration<agent_sample_scheduled_vw>
    {
        public agent_sample_scheduled_vwMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Contact, t.AgentKey, t.Agent, t.ShipCity, t.ShipState, t.ShipName, t.SchShipDate, t.OrderNo, t.ShipToContact, t.im_adres_line1, t.im_adres_line2, t.im_adres_line3, t.so_hdr_remks });
            ...
            this.ToTable("agent_sample_scheduled_vw");
