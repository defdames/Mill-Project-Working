...
{
    public class bam_open_ordersMap : EntityTypeConfiguration<bam_open_orders>
    {
        public bam_open_ordersMap()
        {
            // Primary Key
            this.HasKey(t => new { t.OrderNo, t.COUNTRY, t.OrderQty, t.ShipQty, t.Price, t.AllocQty, t.Status, t.Product, t.PONumber, t.ScheduledShipDate, t.PromiseDate, t.RequiredDate, t.Warehouse, t.Ship_Key, t.GL_CMP_KEY, t.en_ship_name, t.OrderDate, t.so_dtl_key });
