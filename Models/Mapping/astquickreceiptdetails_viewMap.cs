...
{
    public class astquickreceiptdetails_viewMap : EntityTypeConfiguration<astquickreceiptdetails_view>
    {
        public astquickreceiptdetails_viewMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ar_ivhdr_key, t.so_brnch_key, t.ar_gl_cmp_key, t.ar_ship_key, t.so_hdr_key, t.so_cpono, t.so_dtl_key, t.so_prod_key, t.in_item_key, t.im_pack_key, t.in_prod_uom, t.shippedqty, t.po_hdr_stats, t.PO_CO });
            ...
            this.ToTable("astquickreceiptdetails_view");
