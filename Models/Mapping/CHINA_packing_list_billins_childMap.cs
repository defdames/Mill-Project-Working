...
{
    public class CHINA_packing_list_billins_childMap : EntityTypeConfiguration<CHINA_packing_list_billins_child>
    {
        public CHINA_packing_list_billins_childMap()
        {
            // Primary Key
            ...
            this.Property(t => t.billins_text_value)
                .HasMaxLength(1786);
            ...
            this.ToTable("CHINA_packing_list_billins_child");
            this.Property(t => t.a).HasColumnName("a");
            this.Property(t => t.b).HasColumnName("b");
            this.Property(t => t.billins_text_value).HasColumnName("billins_text_value");
