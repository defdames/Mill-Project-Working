...
{
    public class BGL_Inc_netprofitMap : EntityTypeConfiguration<BGL_Inc_netprofit>
    {
        public BGL_Inc_netprofitMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Type, t.Class, t.Acct, t.AcctDesc, t.Deb_Cred, t.Rtype, t.gl_cmp_key });
            ...
            this.ToTable("BGL_Inc_netprofit");
