...
{
    public class BGL_Inc_NewCostsalesMap : EntityTypeConfiguration<BGL_Inc_NewCostsales>
    {
        public BGL_Inc_NewCostsalesMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Type, t.Class, t.AcctDesc, t.Deb_Cred, t.htype, t.htype1, t.htype2, t.htype3, t.rtype, t.gl_cmp_key });
            ...
            this.ToTable("BGL_Inc_NewCostsales");
