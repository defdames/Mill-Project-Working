...
{
    public class abc_gpm_dbcrm_lbsdols_vw1Map : EntityTypeConfiguration<abc_gpm_dbcrm_lbsdols_vw1>
    {
        public abc_gpm_dbcrm_lbsdols_vw1Map()
        {
            // Primary Key
            ...
            this.ToTable("abc_gpm_dbcrm_lbsdols_vw1");
