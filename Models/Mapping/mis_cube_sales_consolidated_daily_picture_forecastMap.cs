...
{
    public class mis_cube_sales_consolidated_daily_picture_forecastMap : EntityTypeConfiguration<mis_cube_sales_consolidated_daily_picture_forecast>
    {
        public mis_cube_sales_consolidated_daily_picture_forecastMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Ship_Whse, t.Act_Fcst });
            ...
            this.ToTable("mis_cube_sales_consolidated_daily_picture_forecast");
