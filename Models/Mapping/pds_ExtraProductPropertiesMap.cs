...
{
    public class pds_ExtraProductPropertiesMap : EntityTypeConfiguration<pds_ExtraProductProperties>
    {
        public pds_ExtraProductPropertiesMap()
        {
            // Primary Key
            ...
            this.ToTable("pds_ExtraProductProperties");
