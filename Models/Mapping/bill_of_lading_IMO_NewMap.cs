...
{
    public class bill_of_lading_IMO_NewMap : EntityTypeConfiguration<bill_of_lading_IMO_New>
    {
        public bill_of_lading_IMO_NewMap()
        {
            // Primary Key
            this.HasKey(t => new { t.so_load_key, t.so_hdr_key, t.so_dtl_key, t.ar_ship_key, t.so_hdr_cpono, t.ar_bill_key, t.FrgtKey, t.WhsName, t.WhsLine1, t.HM, t.in_whs_key, t.gl_cmp_key, t.so_dtl_stats, t.IM_PACK_KEY, t.so_dtlpr_prcuom });
            ...
            this.ToTable("bill_of_lading_IMO_New");
