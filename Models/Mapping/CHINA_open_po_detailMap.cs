...
{
    public class CHINA_open_po_detailMap : EntityTypeConfiguration<CHINA_open_po_detail>
    {
        public CHINA_open_po_detailMap()
        {
            // Primary Key
            this.HasKey(t => new { t.in_buyc, t.in_item_key, t.po_hdr_key, t.po_dtl_key, t.en_vend_key, t.en_vend_name, t.in_desc, t.po_dtl_dueqt, t.po_dtl_ordqt, t.po_dtl_prmdt, t.po_dtl_quotc, t.po_dtl_reqdt, t.po_dtl_stats, t.po_dtl_uom, t.po_hdr_orddt, t.po_hdr_revno, t.in_whs_key, t.gl_cmp_key, t.so_brnch_key, t.notes, t.gl_crncy_key });
            ...
            this.ToTable("CHINA_open_po_detail");
