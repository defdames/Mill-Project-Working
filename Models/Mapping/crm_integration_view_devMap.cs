...
{
    public class crm_integration_view_devMap : EntityTypeConfiguration<crm_integration_view_dev>
    {
        public crm_integration_view_devMap()
        {
            // Primary Key
            ...
            this.ToTable("crm_integration_view_dev");
