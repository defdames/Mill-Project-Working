...
{
    public class channelpartner_detail_sales_tempMap : EntityTypeConfiguration<channelpartner_detail_sales_temp>
    {
        public channelpartner_detail_sales_tempMap()
        {
            // Primary Key
            this.HasKey(t => new { t.channel_partner_code, t.customer_code, t.invoice_number, t.invoice_date, t.product_code, t.units_sold, t.uom, t.dollars, t.approved, t.uploaded });
            ...
            this.ToTable("channelpartner_detail_sales_temp");
