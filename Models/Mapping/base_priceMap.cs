...
{
    public class base_priceMap : EntityTypeConfiguration<base_price>
    {
        public base_priceMap()
        {
            // Primary Key
            this.HasKey(t => new { t.gl_cmp_key, t.pc_bsprhd_key, t.pc_bsprdt_ppcind, t.pc_bsprdt_prod, t.im_pack_key, t.pc_bsprdt_price, t.pc_bsprdt_uom, t.pc_bsprhd_exdesc, t.SOS, t.Currency, t.pc_bsprhd_desc });
            ...
            this.Property(t => t.SOS).HasColumnName("SOS");
