...
{
    public class mis_cube_sales_detail_daily_pictureMap : EntityTypeConfiguration<mis_cube_sales_detail_daily_picture>
    {
        public mis_cube_sales_detail_daily_pictureMap()
        {
            // Primary Key
            this.HasKey(t => new { t.en_ship_name, t.soldto, t.gl_cmp_key, t.ar_bill_key, t.CD, t.Invoice_Num, t.SO_Num, t.Ship_Whse });
            ...
            this.ToTable("mis_cube_sales_detail_daily_picture");
