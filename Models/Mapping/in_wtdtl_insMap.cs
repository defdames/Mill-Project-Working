...
{
    public class in_wtdtl_insMap : EntityTypeConfiguration<in_wtdtl_ins>
    {
        public in_wtdtl_insMap()
        {
            // Primary Key
            this.HasKey(t => new { t.gl_cmp_key, t.in_wthdr_towhs, t.in_wthdr_key, t.in_wtdtl_key, t.im_insmst_key });
