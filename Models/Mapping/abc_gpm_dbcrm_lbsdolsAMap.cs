...
{
    public class abc_gpm_dbcrm_lbsdolsAMap : EntityTypeConfiguration<abc_gpm_dbcrm_lbsdolsA>
    {
        public abc_gpm_dbcrm_lbsdolsAMap()
        {
            // Primary Key
            ...
            this.ToTable("abc_gpm_dbcrm_lbsdolsA");
