...
{
    public class CHINA_invoice_cspxfins_childMap : EntityTypeConfiguration<CHINA_invoice_cspxfins_child>
    {
        public CHINA_invoice_cspxfins_childMap()
        {
            // Primary Key
            ...
            this.ToTable("CHINA_invoice_cspxfins_child");
