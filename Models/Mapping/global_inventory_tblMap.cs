...
{
    public class global_inventory_tblMap : EntityTypeConfiguration<global_inventory_tbl>
    {
        public global_inventory_tblMap()
        {
            // Primary Key
            this.HasKey(t => new { t.gl_cmp_key, t.in_whs_key, t.en_prod_key, t.in_lot_key });
            ...
            this.ToTable("global_inventory_tbl");
