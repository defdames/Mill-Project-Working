...
{
    public class mis_cube_salesfcst_daily_pictureMap : EntityTypeConfiguration<mis_cube_salesfcst_daily_picture>
    {
        public mis_cube_salesfcst_daily_pictureMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Company, t.Act_Fcst, t.InterCoRegion, t.salesmgr });
            ...
            this.ToTable("mis_cube_salesfcst_daily_picture");
