...
{
    public class crm_integration_view_oldMap : EntityTypeConfiguration<crm_integration_view_old>
    {
        public crm_integration_view_oldMap()
        {
            // Primary Key
            ...
            this.ToTable("crm_integration_view_old");
