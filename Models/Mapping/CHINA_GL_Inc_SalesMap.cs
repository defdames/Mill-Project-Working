...
{
    public class CHINA_GL_Inc_SalesMap : EntityTypeConfiguration<CHINA_GL_Inc_Sales>
    {
        public CHINA_GL_Inc_SalesMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Type, t.Class, t.Acct, t.AcctDesc, t.Deb_Cred, t.PeriodYR, t.PeriodID, t.gl_cmp_key });
            ...
            this.ToTable("CHINA_GL_Inc_Sales");
