...
{
    public class mis_cube_salesfcst_forecast_customer_pricing_daily_picture_tempMap : EntityTypeConfiguration<mis_cube_salesfcst_forecast_customer_pricing_daily_picture_temp>
    {
        public mis_cube_salesfcst_forecast_customer_pricing_daily_picture_tempMap()
        {
            // Primary Key
            ...
            this.ToTable("mis_cube_salesfcst_forecast_customer_pricing_daily_picture_temp");
