...
{
    public class distdb_cprdsales_tbl_usr_temp2Map : EntityTypeConfiguration<distdb_cprdsales_tbl_usr_temp2>
    {
        public distdb_cprdsales_tbl_usr_temp2Map()
        {
            // Primary Key
            ...
            this.ToTable("distdb_cprdsales_tbl_usr_temp2");
