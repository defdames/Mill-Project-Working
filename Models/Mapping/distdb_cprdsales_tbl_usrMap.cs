...
{
    public class distdb_cprdsales_tbl_usrMap : EntityTypeConfiguration<distdb_cprdsales_tbl_usr>
    {
        public distdb_cprdsales_tbl_usrMap()
        {
            // Primary Key
            ...
            this.ToTable("distdb_cprdsales_tbl_usr");
