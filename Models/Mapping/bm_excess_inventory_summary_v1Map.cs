...
{
    public class bm_excess_inventory_summary_v1Map : EntityTypeConfiguration<bm_excess_inventory_summary_v1>
    {
        public bm_excess_inventory_summary_v1Map()
        {
            // Primary Key
            ...
            this.ToTable("bm_excess_inventory_summary_v1");
