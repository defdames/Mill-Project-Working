...
{
    public class bill_of_lading_mstrMap : EntityTypeConfiguration<bill_of_lading_mstr>
    {
        public bill_of_lading_mstrMap()
        {
            // Primary Key
            this.HasKey(t => new { t.so_load_key, t.so_hdr_key, t.so_dtl_key, t.ar_ship_key, t.so_hdr_cpono, t.ar_bill_key, t.FrgtKey, t.WhsName, t.WhsLine1, t.HM, t.in_whs_key });
            ...
            this.ToTable("bill_of_lading_mstr");
            ...
            this.Property(t => t.PalletWt).HasColumnName("PalletWt");
